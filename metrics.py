"""子代理效率实验 · token 计量（2026-09-11 顾主批准 C 步）
...
落盘：配置项 metrics_path，默认 <插件数据目录>/experiments/subagent_efficiency/metrics.jsonl
...
class MetricsMixin:
    ...
    _METRICS_DEFAULT_PATH = (
        "<插件数据目录>/experiments/subagent_efficiency/metrics.jsonl"
    )
