...
博士 2026-09-03 拍板三期重版：接话人不能被算死、每人日常话题随机演化。
...
LIFE_DOMAINS: List[str] = [
    ...
    "出差/外勤",# 出门的事、所见所闻
    "八卦/事",  # 身边人/罗德岛大小事
    "私房",     # 想他的私密时刻（2026-09-04 博士拍板 A：真随机也能下流一点）
]
...
PERSONA_DOMAIN_WEIGHTS: Dict[str, Dict[str, float]] = {
    # 阿米娅：领袖副手兼照顾者——工作操心 + 生活日常交替（私房给极低：害羞款）
    "amiya":     {"工作": 3, "生活": 3, "八卦/事": 2, "兴趣": 2, "深夜随笔": 1, "私房": 0.5},
    # 可露希尔：总工程师——焊板子赶工是常态，深夜随笔是补觉前的胡话（放得开，私房权重高）
    "closure":   {"工作": 5, "吐槽": 3, "深夜随笔": 3, "兴趣": 2, "生活": 1, "私房": 2},
    # 特蕾西娅：隐退的温柔魔王，缝纫幼师——日常烟火气+偶尔旧事（温柔款私房）
    "theresia":  {"生活": 4, "深夜随笔": 3, "兴趣": 2, "八卦/事": 2, "工作": 1, "私房": 1},
    # 斯卡蒂：话少深情的前深海猎人——外勤奔波 + 沉默的思绪（沉默的想他款）
    "skadi":     {"工作": 3, "出差/外勤": 3, "深夜随笔": 2, "生活": 2, "私房": 1},
    ...
    # 梨诺：歌姬偶像——舞台工作 + 音乐兴趣是主旋律（放得开，私房权重高）
    "liino":     {"工作": 4, "兴趣": 4, "生活": 2, "深夜随笔": 1, "私房": 2},
    # M3：医疗顾问新战士——门诊工作 + 求知兴趣 + 吐槽战场见闻（黏人款私房）
    "m3":        {"工作": 4, "兴趣": 3, "吐槽": 2, "生活": 2, "私房": 1},
    # 凯尔希：罗德岛操盘手——政务工作几乎就是她的全部日常（极低，工作占满）
    "kaltsit":   {"工作": 6, "吐槽": 2, "深夜随笔": 1, "生活": 1, "私房": 0.5},
}

# 5% 完全随机事件：跳出角色底色邻域，掷一个"今天有点不一样"的日子
WILD_CHANCE: float = 0.05
# B（2026-09-04 博士拍板）：跳脱里再 roll 一次"今天格外想他"——
...
# 博士 16:45 实证：黍的"刚开完会（一个人）"8-26 与 8-30 撞车、
