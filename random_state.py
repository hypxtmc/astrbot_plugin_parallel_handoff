...
PERSONA_DOMAIN_WEIGHTS: Dict[str, Dict[str, float]] = {
    # 助手A：领袖副手兼照顾者——工作操心 + 生活日常交替
    "agent_a":     {"工作": 3, "生活": 3, "八卦/事": 2, "兴趣": 2, "深夜随笔": 1},
    # 助手B：总工程师——焊板子赶工是常态，深夜随笔是补觉前的胡话
    "agent_b":   {"工作": 5, "吐槽": 3, "深夜随笔": 3, "兴趣": 2, "生活": 1},
    # 助手C：隐退的温柔魔王，缝纫幼师——日常烟火气+偶尔旧事
    "agent_c":  {"生活": 4, "深夜随笔": 3, "兴趣": 2, "八卦/事": 2, "工作": 1},
    # 助手D：话少深情的前深海猎人——外勤奔波 + 沉默的思绪
    "agent_d":     {"工作": 3, "出差/外勤": 3, "深夜随笔": 2, "生活": 2},
    ...
    # 助手F：歌姬偶像——舞台工作 + 音乐兴趣是主旋律
    "agent_f":     {"工作": 4, "兴趣": 4, "生活": 2, "深夜随笔": 1},
    # M3：医疗顾问新战士——门诊工作 + 求知兴趣 + 吐槽战场见闻
    "m3":        {"工作": 4, "兴趣": 3, "吐槽": 2, "生活": 2},
    # 助手E：组织操盘手——政务工作几乎就是她的全部日常
    "agent_e":   {"工作": 6, "吐槽": 2, "深夜随笔": 1, "生活": 1},
}
