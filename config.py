...
class ConfigMixin:
    ...
    # ── 双模式调度配置（技术干活 / 后宫贴贴，2026-08-31 博士指定） ──
    ...
    def _get_mode_config(self, mode: str) -> dict:
        ...
        博士可在 WebUI 填写 `tech_mode_config` / `affection_mode_config`（JSON 字符串），
        自行决定每个模式的调度方式：
        {
